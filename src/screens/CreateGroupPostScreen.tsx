// CreateGroupPostScreen.js - With Create and Update functionality and location text storage
...
// Main CreateGroupPostScreen Component
const CreateGroupPostScreen = () => {
  ...
  const loadPostData = async () => {
    ...
    try {
      const post = await getPostById(editingPostId, groupId);
      if (post) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>
          {isEditing ? 'Edit Post' : `Create Post in ${groupName}`}
        </Text>
